(function() {
    ...
    class RTLTableWidget extends HTMLElement {
        constructor() {
            ...
            // Sample Hebrew data
            this._tableData = [
                {"שם": "יוחנן כהן", "גיל": "29", "עיר": "תל אביב", "תפקיד": "מהנדס תוכנה"},
                {"שם": "שרה לוי", "גיל": "34", "עיר": "ירושלים", "תפקיד": "מנהלת פרויקטים"},
                {"שם": "דוד ישראלי", "גיל": "31", "עיר": "חיפה", "תפקיד": "מעצב גרפי"},
                {"שם": "רחל אברהם", "גיל": "27", "עיר": "באר שבע", "תפקיד": "רופאה"},
                {"שם": "משה דוד", "גיל": "38", "עיר": "נתניה", "תפקיד": "עורך דין"}
            ];
        ...
        _render() {
            ...
            if (!this._tableData || this._tableData.length === 0) {
                tableBody.innerHTML = '<tr><td colspan="100%" class="no-data">אין נתונים להצגה</td></tr>';
                return;
            }
